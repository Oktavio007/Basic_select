...
SELECT actor_id, first_name, last_name
FROM actor
WHERE actor.first_name = 'KENNETH';

SELECT actor_id, first_name, last_name
FROM actor
WHERE actor.first_name = 'KENNETH' AND actor_id < 100;
...
SELECT  *
FROM actor
WHERE NOT first_name = 'KENNETH' AND NOT actor_id < 100;
